...
- (UIColor *)complementaryColor {
	...
	return [UIColor colorFromHue:h saturation:s brightness:v alpha:a];
}
...
- (NSArray*)analogousColorsWithStepAngle:(CGFloat)stepAngle pairCount:(int)pairs {
	...
	for (int i = 1; i <= pairs; ++i) {
		...
		[colors addObject:[UIColor colorFromHue:h1 saturation:s brightness:v alpha:a]];
		[colors addObject:[UIColor colorFromHue:h2 saturation:s brightness:v alpha:a]];
	}
